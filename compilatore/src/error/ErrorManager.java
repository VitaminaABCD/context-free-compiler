	...
	public static void manage(ERROR_TYPE type, Exception e) throws Exception{
		switch(type){
			...
			case INVALID_GRAMMAR:
				System.out.println("Contex-free incompleto si ricorda che il contex free � composto da 4 righe contenti rispettivamente:/n Assioma/n Non Terminali /n Non Terminali/n Produzioni nella forma A::=bBc, B::= (C)/n gli elementi della produzione non devono essere separati da uno spazio");
				//TODO log4j
				break;
